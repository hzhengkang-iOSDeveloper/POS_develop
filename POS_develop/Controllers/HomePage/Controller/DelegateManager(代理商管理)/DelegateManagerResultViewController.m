...
- (void)loadAgentListRequest {
    [[HPDConnect connect] PostNetRequestMethod:@"api/trans/agent/list" params:@{@"userid":USER_ID_POS, @"agentName":self.agentName, @"agentNo":self.agentNo,@"needDes":@"1"} cookie:nil result:^(bool success, id result) {
